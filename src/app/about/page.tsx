...
const ExampleComponent = ({title, desc}:{title:string, desc:string}) => (
  ...
  <div className="mt-4 text-center">
    <h3 className="text-xxl font-semibold">{title}</h3>
...
function MyPage() {
  ...
  return (
    ...
    <ExampleComponent title="Meme 1" desc="The Dankest Meme"/>
